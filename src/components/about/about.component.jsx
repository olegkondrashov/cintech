...
const About = () => {
    return (
        <section
            id="about"
            className="relative text-white overflow-hidden h-[70vh]"
            style={{
      ...
      */}
            <div className="relative z-10 mx-auto max-w-screen-xl px-4 py-16 flex flex-col md:flex-row items-start md:items-center gap-10 md:gap-16">
